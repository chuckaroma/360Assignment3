...
center5 = Vec3(0, 3, -5)
center6 = Vec3(-1.2, 1, -4)
center7 = Vec3(1.0, 1, -4.5)
...
color6 = Vec3(1.0, 1.0, 0.0)
color7 = Vec3(1.0, 0.0, 1.0)
color8 = Vec3(1.0, 0.5, 0.5)
mirror1 = True
mirror2 = False
mirror3 = False
mirror4 = False
...
mirror7 = False
mirror8 = False
mirrorList = [mirror1, mirror2, mirror3, mirror4, mirror5, mirror6, mirror7, mirror8]
sphereCenterList = [center1, center2, center3, center4, center5, center6, center7, center8] #Radi, centers, mirrors and colors are stored in lists
radiusList = [radius1, radius2, radius3, radius4, radius5, radius6, radius7, radius8]
